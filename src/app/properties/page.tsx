      ...
      <section className=" pb-10 lg:pb-20 bg-white dark:bg-dark relative overflow-hidden">
        <div className="container mx-auto">
          <div className="w-full px-4">
            {/* Heading */}
            <div className="flex flex-col sm:flex-row mb-6 w-full justify-between items-start sm:items-center gap-6 mt-8">
              {/* Heading */}
              <h2 className="text-lg text-gray-500 relative after:absolute after:-bottom-4 after:h-1 after:w-[1000px] after:bg-gray-300 after:left-0 after:right-0 after:mx-auto after:rounded-full mb-4 sm:mb-0">
                26 properties found
              </h2>

              {/* Sort Button */}
              <button className="text-sm border border-gray-400 text-gray-500 rounded-lg px-3 py-1">
                Sort by
              </button>
            </div>
