  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        ...
        // If data is not an array, try to extract blogs from the response
        let blogsArray: Blog[] = [];
        if (Array.isArray(data)) {
          ...
          // If it's a single blog object, wrap it in an array
          blogsArray = [data];
        }

        // Clean and validate blog data
        blogsArray = blogsArray.map((blog) => {
          // Log the blog image URL for debugging
          console.log("Processing blog image:", blog.blogImage);

          // Clean the blog image URL
          ...
          if (blog.blogImage) {
            try {
              ...
              console.error("Invalid image URL:", blog.blogImage, e);
            }
          }
              ...
              {blog.blogImage && (
                <div className="relative w-full h-full">
                  <Image
                    ...
                    onError={(e) => {
                      console.error('Image load error:', blog.blogImage);
