...
// import bgImage from '../../public/assets/hero.jpg';
...
>
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Realtra Spaces - Modern Real Estate" 
            fill
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
          <div className="text-center max-w-4xl mx-auto text-white">
            <p className="uppercase tracking-[2px] text-amber-400 mb-6 font-medium text-sm">
              CAREERS AT REALTRA SPACES
            </p>
            
            <h1 className="text-white mb-8 font-light text-5xl md:text-7xl leading-tight tracking-wide">
              Shape the Future of <br/>
              <span className="text-amber-400 font-medium">Real Estate</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="#open-roles">
                <button className="bg-amber-500 hover:bg-amber-400 text-black font-medium px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105">
              ...
              <Link href="#culture">
                <button className="border-2 border-white text-white hover:bg-white hover:text-slate-900 font-medium px-8 py-4 rounded-lg transition-all duration-300">
                  Our Culture
                </button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="text-center p-6" data-aos="fade-up" data-aos-delay={index * 100}>
                ...
                <h3 className="text-2xl font-medium text-slate-900 mb-4">{item.title}</h3>
      ...
      {/* Benefits Section */}
      <section id="culture" className="py-20 bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <p className="uppercase text-sm font-medium tracking-wider text-amber-600 mb-4">
              EMPLOYEE BENEFITS
            </p>
            <h2 className="text-4xl md:text-5xl font-light text-slate-900 mb-6">
        ...
        <div className="container max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                {isLoading ? (
                  ...
                  <div className="p-8 text-center">
                    <p className="text-gray-600 mb-4">No open positions at the moment.</p>
                  ...
                  jobs.map((job, index) => (
                    <Link 
                      key={job.id}
                      href={job.link}
                      className={`block p-6 hover:bg-amber-50 transition-all duration-300 border-b border-gray-100 last:border-b-0 group ${
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="bg-amber-500 text-white p-3 rounded-full group-hover:bg-amber-600 transition-colors">
                          <ArrowRight size={18} />
                        </div>
                      </div>
                    </Link>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-8 text-white h-full">
                ...
                <Link href="#apply">
                  <button className="bg-amber-500 hover:bg-amber-400 text-black font-medium px-6 py-3 rounded-lg transition-all duration-300 flex items-center gap-2">
                    Submit Your Resume
                    <ArrowRight size={16} />
                  </button>
                </Link>
      ...
      {/* Application Section */}
      <section id="apply" className="py-20 bg-gradient-to-br from-slate-50 to-gray-100">
            ...
            <div className="p-8 md:p-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mb-8">
                  <label 
                    htmlFor="resume" 
                    className="flex items-center justify-center py-4 px-6 border-2 border-dashed border-amber-300 rounded-xl cursor-pointer hover:border-amber-400 hover:bg-amber-50 transition-all duration-300"
                  >
                ...
                <div className="text-center pt-6">
                  <button 
                    ...
                    className="bg-amber-500 hover:bg-amber-400 text-black font-medium px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 mx-auto hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
