            ...
            <main className="min-h-screen bg-gray-100">
                ...
                <div className="mt-6">
                    <div className="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-5xl">
                        <div>
                            <h1 className="text-slate-900 text-3xl font-semibold">Connect with us</h1>
                                ...
                                <ul className="">
                                    <li className="flex items-center">
                                        ...
                                        <a href="javascript:void(0)" className="text-sm ml-4">
                                            <small className="block text-xl text-black">Write to Us</small>
                            ...
                            <div className="mt-4 rounded-xl border border-gray-200 p-3">
                                ...
                                <ul className="">
                                    <li className="flex items-center">
                                        ...
                                        <a href="javascript:void(0)" className="text-sm ml-4">
                                            <small className="block text-xl text-black">Head office</small>
                                            <span className="text-gray-500 text-md font-medium">
                                                Office No. 501, Marvel Edge, Viman Nagar, Pune, Maharashtra 411014
                                            </span>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div className="relative z-10 max-w-xl mx-auto text-center">
                        ...
                        <div className="mt-6 mb-8">
                            <p className="text-gray-500 text-base">
                                Speak with our property specialists and get personalized guidance for your next move.Book a call now and let’s get started.
                            </p>
                        </div>
