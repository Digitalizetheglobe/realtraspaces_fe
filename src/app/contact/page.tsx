            ...
            <div className="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-5xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className={`text-white bg-black hover:bg-white hover:text-black border border-black rounded-full text-[15px] font-medium px-4 py-2 w-full !mt-6 transition-all duration-300 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                >
