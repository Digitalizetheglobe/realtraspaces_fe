                ...
                <div className="max-w-6xl mx-auto py-16 px-4">
                    <div className="flex flex-col sm:flex-row mb-[25px] w-full justify-between items-start gap-6 sm:gap-0">
                        <div className="w-full sm:w-1/2 pr-4">
                            ...
                            <h3 className="text-xl sm:text-2xl lg:text-4xl font-bold text-[#6E6E73]">
                                Built on trust. Designed for ease.
                            </h3>
                        </div>
                        <p className="w-full sm:w-1/2 text-lg text-gray-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                            <div className="p-8">
                                ...
                                <h3 className="text-slate-900 text-lg font-semibold mb-3">Expert Assistance</h3>
                                <p className="text-slate-500 text-sm font-medium leading-relaxed">
